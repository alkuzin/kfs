 ...
 */
constexpr inline usize BITS_TO_BYTES(usize n)
{
 ...
 */
constexpr inline usize BYTES_TO_BITS(usize n)
{
    // assuming that a byte contains 8 bits
    return n << 0x3;
}
 ...
 */
template <typename T>
constexpr inline void set_bit(T& value, s32 pos)
{
    value |= pos;
}
 ...
 */
template <typename T>
constexpr inline void clear_bit(T& value, s32 pos)
{
    value &= ~pos;
}
 ...
 */
template <typename T>
constexpr inline bool test_bit(T& value, s32 pos)
{
    return (value & pos);
}
